...
3. Download the [RPM file](https://packages.endpoint.com/rhel/7/os/x86_64/endpoint-repo-1.7-1.x86_64.rpm) from here and run the following commands:
...
You'll need to **Fork** the cortx-posix repository to clone it into your private GitHub repository. Follow these steps to clone the repository to your gitHub account:
1. Navigate to the 'cortx-posix' repository homepage on GitHub.
2. Click **Fork**
...
Please [contribute to the CORTX POSIX](https://github.com/Seagate/cortx/blob/main/doc/SuggestedContributions.md) initiative and join our movement to make data storage better, efficient, and more accessible. 
