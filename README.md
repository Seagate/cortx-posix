...
Refer to the [CORTX-POSIX Quickstart Guide](https://github.com/Seagate/cortx-posix/blob/dev/doc/CortxPosixQuickStart.md) to build and test the CORTX-POSIX Component.
...
Refer to the [Contributing to CORTX-POSIX](ContributingToCortxPosix.md) document to submit your contributions.
